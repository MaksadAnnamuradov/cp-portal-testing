...
export default {
  ...
  install(Vue, params) {
    ...
    for (var func in GLOBALPOPUPS) {
      Vue.prototype.Sublib[func] = GLOBALPOPUPS[func].bind(
        Vue.prototype.Sublib
      ); // bind the 'this' to the Sublib object so I can access it's properties
    }
    ...
    (Vue.prototype.Sublib.router = {
      ...
      (Vue.prototype.Sublib.doDefaultCreatedPopUp = function(
        _this,
        ignoreSignIn
      ) {
      ...
      // *********************************************************************************
      (Vue.prototype.Sublib.getPopupWidth = function(
        mColumnCount,
        retColCnt,
        asBigAsPossible,
        popUpMode,
        ...
        if (asBigAsPossible) {
          try {
            ...
            if (nodeList) {
              ...
              if (
                this.contains(
                  nodeList[nodeNo].children[0].classList.value,
                  "v-navigation-drawer"
                )
              ) {
                ...
                if (oDimen.x + oDimen.width <= window.innerWidth) {
                  // showing
                  sidePandelWidth = nodeList[nodeNo].getBoundingClientRect()
                    .width;
                  sidePaneOpen = true;
                } else {
                  // hiding
      ...
      (Vue.prototype.Sublib.pageCenterStyle = function(contentWidth = 0) {
        ...
        try {
          ...
          if (nodeList) {
            if (
              this.contains(
                nodeList[0].children[0].classList.value,
                "v-navigation-drawer"
              )
            ) {
              // sidePandelWidth = nodeList[0].getBoundingClientRect().width;
              ...
              if (oDimen.x + oDimen.width <= window.innerWidth) {
                // firefox requires the = to in the <=
                // showing
                sidePandelWidth = nodeList[0].getBoundingClientRect().width;
                sidePaneOpen = true;
              } else {
        ...
        if (sidePandelWidth) {
          ...
          if (false && contentWidth + sidePandelWidth < window.innerWidth) {
            ...
            oRetVal["margin-left"] =
              Math.floor((availSpace - contentWidth) / 2) + "px";
            oRetVal["margin-right"] =
              Math.floor((availSpace - contentWidth) / 2 + sidePandelWidth) +
              "px";

            if (
              Number(this.strtran(oRetVal["margin-left"], "px", "")) >
              sidePandelWidth
            ) {
      ...
      (Vue.prototype.Sublib.contains = function(
        string2Search,
        searchVal,
        caseInsensitve
      ) {
      ...
      (Vue.prototype.Sublib.showMsg = function(
        mText,
        mTimeOut,
        mIndefiniteProgBar
      ) {
    ...
    // *********************************************************************************
    (Vue.prototype.Sublib.toast = function(
      mText,
      mTimeOut,
      mIndefiniteProgBar
    ) {
      ...
      (Vue.prototype.Sublib.wsResp2Obj = function(avfpStr, part, mAll) {
        ...
        if (!avfpStr) {
          oData = {
            errorMsg:
              "Error (17): Server did not respond/ Could not communicate with server. Verify internet connection.",
            wsData: avfpStr
          };
          return oData;
          ...
          try {
            if (this.contains(avfpStr.data, "isCallBackError", true)) {
              ...
              oData = {
                errorMsg:
                  'Error (19) Web Connect Error: "' + oError.message + '"',
                wsData: avfpStr
              };
              return oData;
            }
          ...
          oData = {
            errorMsg:
              "Error (16): Failed to convert web service data to object",
            wsData: avfpStr
          };
          return oData;
          ...
          avfpStr == '{"VFPData":{"rows":}}"' ||
          avfpStr == '{"VFPData":{"rows":[]}}' ||
          (part == 1 &&
            this.left(avfpStr, '{"VFPData":{"rows":[]}}'.length) ==
              '{"VFPData":{"rows":[]}}')
        ) {
          ...
          part == 1 &&
          this.left(avfpStr, '{"errorCode":'.length) == '{"errorCode":'
        ) {
          ...
          try {
            ...
            oData = {
              errorMsg:
                "Error (21): Failed to convert web service data to object",
              wsData: avfpStr
            };
          }
        ...
        if (
          ...
          try {
            ...
            oData = {
              errorMsg:
                "Error (14): Failed to convert web service data to object",
              wsData: avfpStr
            };
          }
          ...
          try {
            ...
            if (this.occurs(avfpStr, "{") > 1) {
              ...
              avfpStr = this.replaceAll(avfpStr, "}", "");
              //avfpStr =this.replaceAll(avfpStr, '""', '"');
              var mHoldErrorCode = avfpStr.substring(
                avfpStr.indexOf(":") + 1,
                avfpStr.indexOf(",")
              ); // "-1"
              mHoldErrorCode = this.replaceAll(mHoldErrorCode, '"', "");

              var mHoldErrorDesc = avfpStr.substr(
                avfpStr.indexOf('errorDesc":') + 'errorDesc":'.length + 1
              ); // "FTSrv Save error....
            ...
            oData = {
              errorMsg:
                "Error (15): Failed to convert web service data to object",
              wsData: avfpStr
            };
          }
        }
      ...
      (Vue.prototype.Sublib.obj2WSResp = function(aData, mPartNo, mAllParts) {
        ...
        if (mPartNo) {
          ...
          mWSData =
            '{"VFPData":{"rows":' +
            (!aData[mPartNo].hasOwnProperty("length") ? "[" : "") +
            JSON.stringify(aData[mPartNo]) +
            (!aData[mPartNo].hasOwnProperty("length") ? "]" : "") +
            "}}";
        ...
        for (var ma = 0; ma < aData.length; ma++) {
          ...
          mWSData +=
            '{"VFPData":{"rows":' +
            (!aData[ma].hasOwnProperty("length") ? "[" : "") +
            JSON.stringify(aData[ma]) +
            (!aData[ma].hasOwnProperty("length") ? "]" : "") +
            "}}";
        } // for
      ...
      (Vue.prototype.Sublib.csv2JSON = function(
        csvStr,
        delimeter,
        lineEndingChar,
        oLines
        ...
        if (this.left(csvStr, "https://".length) == "https://") {
          ...
          return new Promise(async (resolve, reject) => {
            ...
            let aRetVal = _this.csv2JSON(
              csvStr,
              delimeterHold,
              lineEndingCharHold
            ); // recursive call so method can be both sync and async
            resolve(aRetVal);
          });
        }
        ...
        let regExSplitter = new RegExp(
          `${delimeter}(?=(?:(?:[^"]*"){2})*[^"]*$)`
        ); // split on comma but ignore commas inside of quotes (i.e. "1,000" or an addres). See https://stackoverflow.com/questions/11456850/split-a-string-by-commas-but-ignore-commas-within-double-quotes-using-javascript
            ...
            if (mx == 1) {
              ...
              oHeaders = oHeaders.map((item, index) => {
                ...
                if (
                  ...
                  (this.occurs(holdVal, "/") == 2 || holdVal.contains("T")) &&
                  typeof this.newDate(holdVal).getMonth == "function"
                ) {
    ...
    (Vue.prototype.Sublib.getWebJSON = async function(mJSONURL, returnStr) {
      ...
      if (returnStr) return await resp.text(); // useful if
      ...
      (Vue.prototype.Sublib.replaceAll = function(
        str,
        find,
        replace,
        caseInsensitive
        ...
        if (occurance) {
          ...
          if (mIndex < 0) {
            ...
            mRetVal =
              ...
              replace +
              str.substring(mIndex + find.length);
          }
      ...
      (Vue.prototype.Sublib.isIOS = function(onlyWant) {
        ...
        if (retval && onlyWant) {
          ...
          if (
            onlyWant == "ipad" &&
            !this.contains(platform.product, "ipad", true)
          ) {
            retval = false;
          } else if (
            onlyWant == "iphone" &&
      ...
      (Vue.prototype.Sublib.getSecLevels = async function() {
        ...
        if (simUserid) oParams.userId = simUserid;
      ...
      (Vue.prototype.Sublib.usingWebview = function(mPlatform) {
        ...
        if (mPlatform == "android") {
          ...
          if (typeof webkit != "undefined") {
            ...
            return (
              this.isIOS() &&
              !this.contains(this.getDeviceInfo().ua, "safari", true)
            );
          }
        } else {
          return false;
      ...
      (Vue.prototype.Sublib.getLocation = async function(
        mLetNoLocThrough,
        mRevGeo
      ) {
        ...
        return new Promise(async (resolve, reject) => {
          ...
          if (
            this.contains(location.href, "cpkey") ||
            this.contains(location.pathname, "signUp", true) ||
            this.contains(location.pathname, "redirect", true)
          ) {
          ...
          if (!("geolocation" in navigator)) {
            (oRetVal.errorMsg =
              "Browser does not support location services. CenPoint Mobile will only work with location services turned on."),
          ...
          navigator.geolocation.getCurrentPosition(
            ...
            async nolocation => {
              ...
              if (nolocation.code == 1) {
                // permission deneid
                oRetVal.errorMsg =
                  "Location services must be enabled for CenPoint Mobile to work." +
    ...
    (Vue.prototype.Sublib.milTime = function(date) {
      ...
      (Vue.prototype.Sublib.DTOC = function(
        date,
        format,
        symbol,
        honorBranchFormat,
      ...
      // *********************************************************************************
      // Returns: Char
      (Vue.prototype.Sublib.getTimeZone = function(
        onlyGMTOffset,
        onlyGMTOffsetNoLbl,
        mDate2Test,
        onlyLbl,
      ...
      (Vue.prototype.Sublib.convFromStr = function(strToTrans) {
        ...
        if (typeof strToTrans === "undefined" || strToTrans == null) {
          ...
          strToTrans.toUpperCase() === "TRUE" ||
          strToTrans.toUpperCase() === "FALSE"
        ) {
          // boolean
          mRetVal = strToTrans.toUpperCase() == "TRUE" ? true : false;
        } else if (
          strToTrans.toUpperCase() === "UNDEFINED" ||
          strToTrans.toUpperCase() === "NULL"
        ) {
          // null
          mRetVal = null;
        } else {
      ...
      (Vue.prototype.Sublib.getInBetween = function(string, fstring, lstring) {
        ...
        if (typeof fstring === "string") {
          ...
          const middle = string.slice(fstring, fstring + lstring + 1);
          return middle;
        }
      }), // left
      // *********************************************************************************
      // Return a date like: 'Thu, Jan 25, 2019'
      (Vue.prototype.Sublib.obviousDt = function(
        mDate,
        mIncludeYear,
        mExcludeDOW,
        retEmpty
      ...
      (Vue.prototype.Sublib.daysBetween = function(
        firstDate,
        secondDate,
        wantAbs
      ) {
        ...
        if (
          this.getTimeZone(false, true, date1) !=
          this.getTimeZone(false, true, date2)
        ) {
          // NOTE: I'm assuming that both offsets will be '-' or '+' of UTC, NOT one that's '-' and one that's '+'
          var mDate1OffSet = this.left(
            this.getTimeZone(false, true, date1)
              .replace(":", "")
              .replace("-", ""),
            2
          ); // '-07:00' => '07'
          var mDate2OffSet = this.left(
            this.getTimeZone(false, true, date2)
              .replace(":", "")
              .replace("-", ""),
            2
      ...
      (Vue.prototype.Sublib.getDate = async function(
        mGetFromCache,
        mNoRefresh
      ) {
        ...
        if (!mGetFromCache) {
          ...
          try {
            ...
            if (
              !mNoRefresh &&
              !this.offline() &&
              Math.abs(mDateHold - this.getUTCDate(new Date())) / 1000 / 60 >=
                60
            ) {
      ...
      (Vue.prototype.Sublib.convUTCDate2Local = function(
        date2Conv,
        mUTCMinOffset
      ) {
        // date2Conv = Date
      ...
      (Vue.prototype.Sublib.serializeDt = function(date2Ser) {
        ...
        return (
          String(date2Ser.getFullYear()) +
          "-" +
          this.padL(String(date2Ser.getMonth() + 1), 2, "0") +
          "-" +
          this.padL(String(date2Ser.getDate()), 2, "0") +
          "T" +
          this.padL(String(date2Ser.getHours()), 2, "0") +
          ":" +
          this.padL(String(date2Ser.getMinutes()), 2, "0") +
          ":" +
          this.padL(String(date2Ser.getSeconds()), 2, "0")
        );
      }), // serializeDt
      // *********************************************************************************
      ...
      (Vue.prototype.Sublib.clearAppNotif = async function(oNotification) {
        ...
        for (var mx = 0; mx < aAppNotifs.length; mx++) {
          if (
            aAppNotifs[mx].msg != oNotification.msg ||
            aAppNotifs[mx].time != oNotification.time
          ) {
            continue;
          }
      ...
      (Vue.prototype.Sublib.applyInputMask = function(number, mMask, retZero) {
        ...
        if (typeof number == "number") {
          ...
          if (numIsNeg) number = number.substring(1);
        }
        ...
        if (typeof number != "undefined" && mMask) {
          ...
          var mCleanNum = this.cleanNumber(
            number,
            this.left(String(number), 1) == "-" &&
              this.occurs(String(number), "-") == 1
          );
          ...
          if (mCleanNum.length > this.occurs(mMask, "#")) {
            ...
            this.math.eval(() => Number(number) - Math.floor(Number(number))) ==
              0 &&
            this.occurs(mMask, ".")
          ) {
            ...
            if (
              String(Math.floor(Number(number))).length >
              this.occurs(mHoldInputMask, "#")
            ) {
              mCleanNum = "*".repeat(mCleanNum.length);
            }
          }
          ...
          if (this.contains(String(number), ".")) {
            ...
            mDecPointAlready = String(number)
              .substr(String(number).indexOf("."))
              .replace(".", "").length;
          }

          if (
            this.contains(mMask, ".") &&
            (!this.contains(String(number), ".") ||
              mDecPointAlready < mDecPointsTotal)
          ) {
            // deal with the input mask wanting decimals but a whole number was passed in
            // i.e. ###.## and passed in 125
            mCleanNum =
              this.padL("", mDecPointsTotal - mDecPointAlready, "0") +
              mCleanNum;
          } else if (
            this.contains(mMask, ".") &&
            mDecPointAlready > mDecPointsTotal
        ...
        if (
          !this.isNumeric(this.left(mRetNum, 1)) &&
      ...
      // RETURNS: String
      (Vue.prototype.Sublib.cleanNumber = function(
        number,
        mKeepNeg,
        mKeepPeriod
      ) {
      ...
      (Vue.prototype.Sublib.callNumber = function(number) {
        var mHasPhoneDialer = this.convFromStr(
          localStorage.getItem("devHasDialer")
        );
        if (mHasPhoneDialer) {
      ...
      (Vue.prototype.Sublib.email_DlftMailClient = function(
        email,
        subject,
        body
      ) {
      ...
      (Vue.prototype.Sublib.nav2Addr = function(
        lat,
        long,
        physical,
        mailing,
        ...
        if (retIFrameURL) mPrefMap = "google";
        ...
        if (mStartingLoc || mStop1 || mStop2 || mStop3) {
          ...
          this.toast(
            "Switching from " +
              mPrefMap +
              " to google to map multiple locations"
          );
          mPrefMap = "google";
        }
        ...
        if (retIFrameURL) {
          ...
          mURL =
            "https://www.google.com/maps/dir/?api=1&destination=" + mAddress;
        }
      ...
      (Vue.prototype.Sublib.updtWSCache = async function(
        mCacheKey,
        mName,
        mValue,
        mRespObjNum,
        ...
        if (
          typeof mRespObjSubNum == "number" &&
          oCache[mRespObjNum][mRespObjSubNum]
        ) {
      ...
      (Vue.prototype.Sublib.downloadFile = function(
        base64Str,
        fileName,
        mFileOnServer,
        mForceFileOnServerDownload,
        file2SaveHandle
      ) {
        // base64Str = Char.
        ...
        if (
          ...
          (base64Str || mForceFileOnServerDownload)
        ) {
        ...
        if (
          !base64Str &&
          mFileOnServer &&
          (mForceFileOnServerDownload || this.isIOS() || this.isAndroid())
        ) {
          ...
          this.getBase64ForURL(mFileOnServer).then(function(base64Str) {
            if (
              base64Str &&
              _this.left(base64Str, 5).toUpperCase() != "ERROR"
            ) {
              _this.downloadFile(
                base64Str,
                fileName,
        ...
        if (!mFileOnServer && base64Str) {
          try {
            ...
            this.mbox(
              this.getLbl("corrupted file") +
                fileName +
                " base64 string: " +
                base64Str.substring(-10)
            );
            return;
          }
        }
        ...
        if (mFileOnServer && !this.isIOS() && !this.isAndroid()) {
          ...
          if (android.saveBase64File) {
            ...
            // use the old way
            mHRef =
              "data:" + mDataStr + ";name:" + fileName + ";base64," + base64Str;
          }
          ...
          mHRef =
            "data:" + mDataStr + ";name:" + fileName + ";base64," + base64Str; // above code stopped working and it was downloading octet-stream which was causing problems. MA 05/04/2023
        } else if (this.isIOS()) {
          //account for safari browsers in ios
          // as of MA 07/20/2023 this is working for both iPhone and iPad on safari
          mHRef =
            "data:application/octet-stream;base64," +
            encodeURIComponent(base64Str);
          element.setAttribute("filename", fileName);
        } else {
        ...
        if (file2SaveHandle) {
          ...
          file2SaveHandle.createWritable().then(function(writable) {
            ...
            writable.write(byteArray).then(function() {
              // Close the file and write the contents to disk.
              writable.close().then(function() {}); // .close
            }); // .write
          }); // .createWritable
        } else {
          // save it the old way.
      ...
      (Vue.prototype.Sublib.printFile = async function(mURL) {
        ...
        return new Promise(async (resolve, reject) => {
          ...
          let file = new Blob([byteArray], {
            type: this.getMimeType(ext) + ";base64"
          ...
          printJS({
            printable: fileURL,
            type:
              ext == "PDF" || _this.contains(ext, "pdf", true)
                ? "pdf"
                : "image", // 'pdf', 'html', 'image' or 'json'
            base64: false,
            onPrintDialogClose: printDialogClosedFunc,
            onError: printDialogClosedFunc
          });
      ...
      (Vue.prototype.Sublib.launchURL = function(
        mURL,
        oWindowRef,
        mChangeCurTab
      ) {
        ...
        if (this.usingWebview("ios")) {
          ...
          if (!mChangeCurTab) {
            ...
            if (
              ...
              let _this = this;
              this.mbox(
                this.getLbl("popup blocker detected"),
                this.getLbl("instructions"),
                this.getLbl("close")
                ...
                _this.launchHelp(
                  "https://help.cenpoint.com/docs/allow-pop-ups-for-printing" +
                    (hash ? "#" + hash : "")
                );
              });
              return;
      ...
      (Vue.prototype.Sublib.launchDesktop = async function(paramStr) {
        ...
        if (!worked) {
          ...
          let choice = await this.mbox(
            this.getLbl("desktop app not installed"),
            this.getLbl("download") + " " + this.getLbl("<appname>"),
            this.getLbl("close")
          );
          if (choice == 1) {
      ...
      (Vue.prototype.Sublib.getServerList = function() {
        return [
          ...
          //{ label: 'Boise', subdomain: 'wsboise', lat: 43.618881, lon: -116.215019, order: 0, dist: 0 }, // really out of Seattle, but want to pick up other traffic. SRR 01/31/2022
          {
            ...
            order: 0,
            dist: 0
          }, // chicago is a round robin of 3 servers since the traffic is so high there
          {
            label: "Dallas",
            subdomain: "wsdallas",
            lat: 32.7766642,
            ...
            order: 0,
            dist: 0
          }, // Now a round robin to help with traffic load. SRR 03/15/2022
...

          {
            ...
            order: 0,
            dist: 0
          }, // Richmond, Virgina lat / long    SRR 06/15/2023
          {
            label: "Pittsburgh",
            subdomain: "wspittsburgh",
            lat: 39.102873,
            lon: -84.420557,
            order: 0,
            dist: 0
          }, // Cincinatti Lat / Long     really out of Chicago, but want to pick up other traffic. SRR 01/23/2020

          {
            ...
            order: 0,
            dist: 0
          }, // now a round robin to help with A-Core. 1 server out of san fran, the other out of seattle. SRR 01/31/2022
          //{ label: 'Singapore', subdomain: 'wssingapore', lat: 1.290270, lon: 103.851959, order: 0, dist: 0 }, // SRR 06/28/2022. Took out. SRR 10/21/2022
          {
            ...
            subdomain: "wsfountaingreen",
            lat: 40.514115,
            lon: -112.032994,
            order: 0,
            dist: 0
          } // Salt lake order will always be LAST! // Changed name to wsfountaingreen from wsherriman. SRR 07/28/2023
        ];
      }), // getServerList
      // *********************************************************************************
      ...
      (Vue.prototype.Sublib.determineServerOrder = async function() {
        ...
        for (var mx = 0; mx < aList.length; mx++) {
          aList[mx].dist = this.calcDistByGeoCodes(
            oLoc.lat,
            oLoc.lon,
            aList[mx].lat,
            aList[mx].lon
      ...
      (Vue.prototype.Sublib.determineWS = async function() {
        ...
        while (true) {
          ...
          if (
            !this.RestClient.respHasError(
              mResp,
              mURL.replace("ws", oTestServ.subdomain)
            )
          ) {
      ...
      (Vue.prototype.Sublib.calcDistByGeoCodes = function(
        lat1,
        long1,
        lat2,
        long2,
        ...
        if (mMethod == 1) {
          mDist =
            69.1 *
            Math.sqrt(
              Math.pow(lat2 - lat1, 2) + 0.6 * Math.pow(long2 - long1, 2)
            );
        } else if (mMethod == 2) {
          ...
          mDist = Math.pow(Math.pow(mDist, 2) + Math.pow(mDistLong, 2), 0.5);
        } else if (mMethod == 3) {
          var mA1 = Math.sin(lat1 / 57.3) * Math.sin(lat2 / 57.3);
          var mA2 =
            Math.cos(lat1 / 57.3) *
            Math.cos(lat2 / 57.3) *
            Math.cos(long2 / 57.3 - long1 / 57.3);
          var mA = mA1 + mA2;
          // mDist = 3958.75 * ATAN((1 - mA^2)^.5 / mA)
          mDist = 3958.75 * Math.atan(Math.pow(1 - Math.pow(mA, 2), 0.5) / mA); // 3958.75 is radius of the earth (in miles)
        } else {
          return -1;
        }
      ...
      (Vue.prototype.Sublib.bulkAddIDBRecs = async function(
        objectStore,
        aRecs
      ) {
      ...
      (Vue.prototype.Sublib.clearIDB = async function() {
        ...
        for (var mx = 0; mx < oCPDB.aTables.length; mx++) {
          if (
            oCPDB.aTables[mx].toUpperCase() == "pendingWSSave".toUpperCase()
          ) {
          ...
          for (var my = 0; my < aCursor.length; my++) {
            ...
            if (
              ...
              if (
                ...
                !this.contains(
                  oHold.errorMsg,
                  "No additional workers entered for Field Ticket",
                  true
                )
              ) {
                mDataDt = this.newDate("01/01/1900");
      ...
      //
      // Returns: Char.
      (Vue.prototype.Sublib.getPredefinedNotes = async function(
        mNoteType,
        mForceFreshCopy,
        mShowQuickList,
        oTxtRef
        ...
        if (oTxtRef && oTxtRef.$el) {
          ...
          if (oTxtArea)
            mCursor = oTxtRef.$el.querySelectorAll("textarea")[0]
              .selectionStart;
        }
        ...
        let newNote = await this.showSimplePopUp(
          this.Vue.extend(PREDEFINEDNOTES),
          oParams
        );
        ...
        await this.sleep(0.5 * 1000); // give it time to deal with the event so the value is actually updated after this method returns;
      ...
      (Vue.prototype.Sublib.getOfflineTemplate = async function(
        mTemplate,
        mForceFreshCopy
      ) {
      ...
      (Vue.prototype.Sublib.getAllOfflineTemplates = async function() {
        ...
        if (!mNotes) {
          ...
          if (oNotes.errorMsg) {
            ...
            if (
              Math.abs(mNowMiliSec - mCachedAtMiliSec) >=
              24 * 60 * 60 * 1000
            ) {
              mGetFresh = true;
            }
        ...
        if (mGetFresh) {
          ...
          var mNoteHold = await this.RestClient.getNoCache(
            mURL,
            oParams,
            "getNotes~type=" + oParams.notetype
          );
      ...
      (Vue.prototype.Sublib.getTaskList = async function() {
        ...
        if (mTaskListSaved) {
          ...
          if (!this.wsResp2Obj(mTaskListSaved).errorMsg) {
            var mCachedAtMiliSec = this.newDate(
              this.wsResp2Obj(mTaskListSaved)[0].datadt
            ).getTime();
          } else {
          ...
          if (
            Math.abs(mNowMiliSec - mCachedAtMiliSec) < 24 * 60 * 60 * 1000 &&
        ...
        //var resp = await this.RestClient.getNoCache(mURL, oParams);
        var resp = await this.RestClient.postNoCache(
          mURL,
          oParams,
          oBodayParams
        );
      ...
      (Vue.prototype.Sublib.getInspList = async function() {
        ...
        if (inspDefListSaved) {
          ...
          if (!this.wsResp2Obj(inspDefListSaved).errorMsg) {
            var mCachedAtMiliSec = this.newDate(
              this.wsResp2Obj(inspDefListSaved)[0].datadt
            ).getTime();
          } else {
            mCachedAtMiliSec = this.newDate("01/01/1900");
          }
      ...
      (Vue.prototype.Sublib.saveWSPendingSave = async function(mShowMsg) {
        ...
        aData2Save.sort((a, b) => {
          return (
            this.newDate(JSON.parse(a.value).datadt) -
            this.newDate(JSON.parse(b.value).datadt)
          );
        });
        ...
        for (var mx = 0; mx < aData2Save.length; mx++) {
          ...
          if (!oRestCall.url) {
            ...
            if (
              ...
              oRestCall.url =
                ...
                oRestCall.query.prg +
                "/" +
                oRestCall.query.proc; //'cpPayments/getStripePaymentMethod';
            } else {
          ...
          if (this.isTestingIP(true)) {
            if (
              (oRestCall.query &&
                oRestCall.query.prg &&
                oRestCall.query.prg.toUpperCase() == "CPERROR" &&
                oRestCall.query &&
                oRestCall.query.proc == "LOGERROR") ||
              (oRestCall.url &&
                this.contains(oRestCall.url, "cpError/logError", true))
            ) {
          ...
          if (oRestCall.body) {
            resp = await this.RestClient.postNoCache(
              oRestCall.url,
              oRestCall.query,
              oRestCall.body
            );
          } else {
            resp = await this.RestClient.getNoCache(
              oRestCall.url,
              oRestCall.query
            );
          }
          ...
          if (!oData.errorMsg) {
            ...
            this.contains(
              oData.errorMsg,
              "status already set for this wo",
              true
            )
          ) {
            ...
            this.contains(oRestCall.url, "saveBreadCrumb", true) &&
            this.contains(oData.errorMsg, "clocked out", true)
          ) {
      ...
      (Vue.prototype.Sublib.getSystemTheme = function() {
        ...
        var mSystemLight = window.matchMedia("(prefers-color-scheme: light)")
          .matches;
        var mSystemDark = window.matchMedia("(prefers-color-scheme: dark)")
          .matches;
        if (mSystemLight) {
          mRetVal = "light";
        } else if (mSystemDark) {
      ...
      (Vue.prototype.Sublib.getUserName = function() {
        return (
          (localStorage.getItem("userFName")
            ? localStorage.getItem("userFName").trim()
            : "") +
          " " +
          (localStorage.getItem("userLName")
            ? localStorage.getItem("userLName").trim()
            : "")
        );
      }), // getUserName
      // *********************************************************************************
      ...
      // Returns: Numeric
      (Vue.prototype.Sublib.fixNumberInput = function(
        mNumber,
        mTotalLen,
        mDecLen,
        mAllowNeg
      ...
      // *********************************************************************************
      (Vue.prototype.Sublib.savePhoto = async function(
        mType,
        mTypeId,
        oPhoto,
        mEdited,
        ...
        var oPhotoSaveKey =
          ...
          "~picType=Pic~picId=" +
          oPhoto.picId;
        var resp = await this.RestClient.post(
          mURL,
          oParams,
          oBodyParams,
          oPhotoSaveKey,
    ...
    (Vue.prototype.Sublib.parsePhotos = async function(
      mType,
      mTypeId,
      aFileInput,
      mSubId = "",
      ...
      for (var mx = 0; mx < aFilesCopy.length; mx++) {
        ...
        var heicFile = false;
        heicFile =
          this.contains(file.name, "heic", true) ||
          this.contains(file.type, "heic", true);
        ...
        if (!mFileIsImg) {
          ...
          if (this.isTestingIP()) {
            ...
            mMsg +=
              "pdf getting base64time : " +
              (mEndTime.getTime() - mStartTime.getTime()) / 1000 +
              " seconds" +
              "\n";
          }
        } else {
          ...
          if (this.isTestingIP()) {
            mEndTime = new Date();
            var fileSizeMb =
              (4 * Math.ceil(mShrunkDown.length / 3) * 0.5624896334383812) /
              1048576;
            mMsg +=
              "resizing photo time: " +
              (mEndTime.getTime() - mStartTime.getTime()) / 1000 +
              " seconds and now it is " +
        ...
        if (
          ...
          fileName =
            this.justStem(fileName) +
            "_" +
            this.getAddId(true) +
            "." +
            this.justExt(fileName); //image.jpeg => image_12345.jpeg
        }
        ...
        if (
          aPhotosPending.length == mMaxPicsAtOnce ||
          mx == aFileInput.files.length - 1
        ) {
          mStartTime = new Date();
      ...
      if (this.isTestingIP()) {
        ...
        mMsg +=
          "\n" +
          "parsePhotos in total took " +
          (mEndTime.getTime() - mMethodStart.getTime()) / 1000 +
          " seconds" +
          "\n";
      ...
      (Vue.prototype.Sublib.resizePhoto = async function(oFile, mType) {
        ...
        var mExt = oFile.name
          .substr(oFile.name.lastIndexOf(".") + 1)
          .toLowerCase();
        if (mExt == "jpg") {
          mExt = "jpeg";
        }
        ...
        var mRetVal = oCanvasEl.toDataURL(mExt, 0.8); // the 1 can be a Number between 0 and 1 indicating image quality if the requested type is image/jpeg
    ...
    Vue.prototype.Sublib.resizePhotoBase64 = function(
      base64Str,
      maxWidth,
      maxHeight
    ) {
    ...
    // mCurSym is $, £, etc.
    Vue.prototype.Sublib.formatCurrency = function(
      mNumToFormat,
      mCurSym,
      mFormatZeroAs,
      mStripeOffCurSym
    ...
    Vue.prototype.Sublib.getLocBreadCrumb = async function(_this) {
      ...
      if (!_this.locBreadCrumbTimer) {
        ...
        var mLocFreqLastGetDt = this.newDate(
          localStorage.getItem("breadCrumbFreqDt")
        );

        // go get the freq if we don't have it or it's been a day since we did (want to honor the branch setting if it changed)
        if (
          mLocFreq == null ||
          _this.daysBetween(mNow, mLocFreqLastGetDt, true) > 0
        ) {
        ...
        _this.locBreadCrumbTimer = setInterval(
          _this.getLocBreadCrumb,
          mLocFreq * 60 * 1000,
          _this
        );
      }
    ...
    Vue.prototype.Sublib.deviceIsPhone = function() {
      ...
      var mRetVal = /\bi?Phone\b|(?=.*\bAndroid\b)(?=.*\bMobile\b)|(?=.*\bAndroid\b)(?=.*\bSD4930UR\b)/i.test(
        mTest
      );
    ...
    (Vue.prototype.Sublib.getAutoLunchDetails = async function(
      mUserId,
      mDt,
      mIdType2Ignore,
      mId2Ignore
      ...
      (Vue.prototype.Sublib.wantAutoLunch = function(
        oUserTime,
        oAutoLunch,
        mIdType,
        mId
        ...
        if (!oUserTime.startedDtTm) {
          oUserTime.startedDtTm = this.newDate(
            this.DTOC(oUserTime.starteddt) + " " + this.AmPm(oUserTime.started)
          );
          oUserTime.arrivedDtTm = this.newDate(
            this.DTOC(oUserTime.arriveddt) + " " + this.AmPm(oUserTime.arrived)
          );
          oUserTime.departedDtTm = this.newDate(
            this.DTOC(oUserTime.departeddt) +
              " " +
              this.AmPm(oUserTime.departed)
          );
          oUserTime.completedDtTm = this.newDate(
            this.DTOC(oUserTime.completedt) +
              " " +
              this.AmPm(oUserTime.completed)
          );
        }

        if (
          !oAutoLunch.branchautolunch ||
          (oAutoLunch.lunchtaken &&
            (mId != oAutoLunch.lunchtakenid ||
              mIdType != oAutoLunch.lunchtakentype))
        ) {
          ...
          if (mEndTime) {
            var mTotFTMin =
              Math.floor((mEndTime - oUserTime.startedDtTm) / 1000 / 60) +
              oAutoLunch.prevmintot;
          ...
          var mBranchLunchStart = this.newDate(
            mDt + " " + this.AmPm(oAutoLunch.branchlunchstart)
          );
          var mBranchLunchEnd = this.newDate(
            mDt + " " + this.AmPm(oAutoLunch.branchlunchend)
          );

          if (
            (mBranchLunchStart <= oUserTime.startedDtTm &&
              oUserTime.startedDtTm < mBranchLunchEnd) ||
            (mBranchLunchStart < oUserTime.arrivedDtTm &&
              oUserTime.arrivedDtTm < mBranchLunchEnd) ||
            (mBranchLunchStart < oUserTime.departedDtTm &&
              oUserTime.departedDtTm <= mBranchLunchEnd) ||
            (mBranchLunchStart < oUserTime.completedDtTm &&
              oUserTime.completedDtTm <= mBranchLunchEnd) ||
            (oUserTime.startedDtTm < mBranchLunchStart &&
              mBranchLunchEnd < oUserTime.completedDtTm)
          ) {
            mWant2Enable = true;
          } else {
            mWant2Enable = false;
        ...
        if (mWant2Enable) {
          if (!oUserTime.departed && !oUserTime.arrived) {
            ...
            if (
              (mNow - oUserTime.arrivedDtTm) / 1000 / 60 >
              oAutoLunch.branchlunchmin
            ) {
              mWant2Enable = false;
            }
          } else {
            ...
            if (
              mIdType == "FT" &&
              (oUserTime.departedDtTm - oUserTime.arrivedDtTm) / 1000 / 60 <
                oAutoLunch.branchlunchmin
            ) {
              // FT, auto lunch is only taken out of onsite
              mWant2Enable = false;
            } else if (
              (oUserTime.completedDtTm - oUserTime.startedDtTm) / 1000 / 60 <
              oAutoLunch.branchlunchmin
            ) {
              // clock in rec or errand (time is paid as a clock in), use the started vs completed since it's all onsite

              if (
                this.emptyDt(oUserTime.completedDtTm) &&
                (mEndTime - oUserTime.startedDtTm) / 1000 / 60 >=
                  oAutoLunch.branchlunchmin
              ) {
    ...
    //
    // Returns: String
    Vue.prototype.Sublib.getAutoLunchDisabledMsg = function(
      mId,
      mIdType,
      oAutoLunch,
      mAutoLunchEnabled
      ...
      if (oAutoLunch.lunchtaken && oAutoLunch.lunchtakentype == "NA") {
        ...
        oAutoLunch.lunchtakenid &&
        oAutoLunch.lunchtakenid != mId &&
        !oAutoLunch.lunchtakennolunch
      ) {
        // previosly took a lunch
        mMsg = this.getLbl("lunch prev taken on");
        mMsg = mMsg.replace(
          "<FT>",
          oAutoLunch.lunchtakentype +
            " " +
            this.trimZeros(oAutoLunch.lunchtakenid, 5)
        );
        mRetVal = mMsg;
      } else if (
        oAutoLunch.lunchtakenid &&
    ...
    Vue.prototype.Sublib.addToHomeScreen = async function(mPromptNotSignedIn) {
      ...
      if (this.isIOS()) {
        ...
        mAlreadyInstalled = window.matchMedia("(display-mode: standalone)")
          .matches;
      }
      ...
      if (!this.isIOS()) {
        ...
        if (
          this.convFromStr(localStorage.getItem("showedIOSAdd2HSPrompt")) ||
          this.isTestingIP()
        ) {
          return false;
        }
        ...
        mChoice = await this.mbox(
          this.getLbl("add to hs") +
            "<br />" +
            "<br />" +
            "<div>" +
            '<img src="' +
            (this.contains(location.href, "portalbeta", true)
              ? "img/icons/beta/Icon192x192.png"
              : "img/CPcircle.png") +
    ...
    Vue.prototype.Sublib.startRemoteSupportSession = function() {
      ...
      if (this.isIOS()) {
        ...
        window.open(
          "https://play.google.com/store/apps/details?id=com.splashtop.sos&hl=en_US"
        );
      } else {
        // windows
        ...
        if (oDevice.product.toUpperCase() == "MAC") {
          ...
          window.open(
            "https://www.cenpoint.com/remoteSupport_splashTop.dmg",
            "iframe"
          );
        } else {
          //window.open('https://www.cenpoint.com/TeamViewerQS-idcw3wzuh7.exe', '_system');
          window.open(
            "https://www.cenpoint.com/remoteSupport_splashTop.exe",
            "_system"
          );
        }
      }
    ...
    Vue.prototype.Sublib.minToHr = function(mTotMin, mHrSize) {
      ...
      var mRetVal =
        mHoldHr + ":" + this.padL(String(Math.abs(mHoldMin)).trim(), 2, "0");
      if (mWantNeg) {
        mRetVal = "-" + mRetVal;
      }
    ...
    Vue.prototype.Sublib.addChange = function(
      mTable,
      mField,
      mNewValue,
      mOrig
    ...
    Vue.prototype.Sublib.getLastChange = function(oChanges, mTable, mField) {
      ...
      var aHold = oChanges.filter(
        obj => obj.table == mTable && obj.field == mField
      );
      aHold.reverse();
      if (aHold.length == 0) {
        // shouldn't hit this
    ...
    Vue.prototype.Sublib.getDeviceInfo = function(mUAString) {
      ...
      if (
        (this.contains(oRetVal.description, "safari", true) ||
          (oRetVal.browser == "" && oRetVal.product == "Mac")) && // in the webview, iPad doesn't register the browser at all and comes through as a Mac
        !(
          this.contains(oRetVal.description, "iphone", true) ||
          this.contains(oRetVal.description, "ipad", true)
        ) &&
        ...
        oRetVal.description =
          oRetVal.description.substring(0, oRetVal.description.indexOf("on")) +
          "on Apple iPad (" +
          oRetVal.description.substring(oRetVal.description.indexOf("on") + 3) +
          ")";
        ...
        !this.contains(oRetVal.description, "ios", true) &&
        !oRetVal.product
      ) {
      ...
      oRetVal.browser = "";
      if (
        this.contains(oRetVal.name, "edge", true) ||
        oRetVal.ua.contains("Edg/", true)
      ) {
    ...
    Vue.prototype.Sublib.newDate = function(mTimeStr, mNoTime) {
      ...
      if (
        !this.contains(mTimeStr, "T", true) &&
        mTimeStr.length == "11/19/2019".length
      ) {
        ...
        if (this.isNumeric(this.left(mTimeStr, 4))) {
          ...
          mTimeStr =
            this.getYear(mTimeStr) +
            "-" +
            this.getMonth(mTimeStr) +
            "-" +
            this.getDay(mTimeStr) +
            "T00:00:00";
        }
        ...
        mTimeStr = this.serializeDt(new Date(mTimeStr));
      } else if (this.contains(mTimeStr, "M", true)) {
        // AM or PM
      ...
      if (mNoTime) {
        mTimeStr =
          mTimeStr.substr(0, mTimeStr.toUpperCase().indexOf("T") + 1) +
          "00:00:00";
      }
      ...
      if (
        typeof mRetVal.getMonth != "function" ||
        mRetVal.getFullYear() < 1900 ||
        Number.isNaN(mRetVal.getFullYear())
      ) {
    ...
    Vue.prototype.Sublib.handleError = async function(err, vm, info) {
      ...
      mChoice = await Vue.prototype.Sublib.mbox(
        "An error has occured, would you like to send support the error info (including a screen shot)?" +
          "\n\nError: " +
          mErrorMsg,
        "Send",
        "Cancel"
      ...
      if (false) {
        ...
        mVuePrg = Vue.prototype.Sublib.replaceAll(
          mVuePrg,
        ...
        var mBody =
          ...
          mErrorMsg +
          " - " +
          mVuePrg + //aErrorStack[0] + mNL + aErrorStack[1]
          mNL +
          mNL +
          "Page:" +
          location.href +
      ...
      var oCachedWSResp;
      if (
        Vue.prototype.Sublib.contains(
          mErrorStr,
          "Error (18) Web Connect Error",
          true
        )
      ) {
        ...
        oCachedWSResp = await Vue.prototype.Sublib.IDB.req(
          "pendingWSSave",
          "cursor"
        );
      } else {
      ...
      oCachedWSResp.deleteFor(
        obj =>
          obj.key == "userSec" ||
          obj.key == "locale" ||
          obj.key.indexOf("getAllPics") > -1 ||
          obj.key.indexOf("savePhoto") > -1
      ); // don't want to email out the user sec and locale causes problems reparsing
      ...
      var mNotes =
        ...
        oDevice.description +
        "\nTime: " +
        Vue.prototype.Sublib.serializeDt(mTimeStamp) +
        "\nPage: " +
        location.href +
        "\n" +
        "\nError: " +
      ...
      var resp = await Vue.prototype.Sublib.RestClient.saveData(
        mURL,
        {},
        oBodyParams,
        "errorSend2Support~timeStamp=" + oBodyParams.timeStamp
      );
    ...
    Vue.prototype.Sublib.logError = async function(err, vm, info) {
      ...
      var resp = await Vue.prototype.Sublib.RestClient.saveData(
        ...
        {},
        oBodyParams,
        "logError~timeStamp=" + oBodyParams.timeStamp
      );
      var oData = Vue.prototype.Sublib.wsResp2Obj(resp);
      if (oData.errorMsg) {
      }
    ...
    Vue.prototype.Sublib.getNumberParts = function(mNumber) {
      ...
      if (this.contains(mNumber, ".")) {
        ...
        oRetVal.decNumAsDec = Number(
          "." + mNumber.substr(mNumber.indexOf(".") + 1)
        ); // 0.xxxx
    ...
    Vue.prototype.Sublib.emptyDt = function(mDate2Test) {
      ...
      return (
        this.newDate(mDate2Test).getFullYear() <= 1900 ||
        this.newDate(mDate2Test).getFullYear() == 1970
      );
    }; // emptyDt

    // *********************************************************************************
    // Geo code an address / get some info about it
    Vue.prototype.Sublib.getAddressInfo = async function(
      mAddr1,
      mCity,
      mState
    ) {
    ...
    Vue.prototype.Sublib.isTestingIP = function(mOnlyDevIps) {
      return (
        (!mOnlyDevIps &&
          (this.contains(location.href, "jamie") ||
            this.contains(location.href, "max") ||
            this.contains(location.href, "alphaportal.") ||
            this.contains(location.href, "localportal."))) ||
        this.contains(location.href, "192.168.10.") ||
    ...
    Vue.prototype.Sublib.isProdDB = function(mDevOnly) {
      ...
      if (this.inList(custCode, "TEST", "TEST2", "TEST3", "DEMO", "MAX")) {
        ...
        if (
          this.inList(custCode, "TESTEXT") ||
          this.left(custCode, 2).toUpperCase() == "CP"
        ) {
          // i.e. 'CPCutting', etc.
          retval = false;
        }
    ...
    Vue.prototype.Sublib.canUserAcceptJobs = async function(
      mUserId,
      mDt,
      mStartTm,
      mEndTm,
      mJobschedId2Ignore,
      mJobschedId4Training,
      mSilent
    ) {
      ...
      if (oData.errorMsg) {
        if (
          this.contains(oData.errorMsg, "Scheduling Conflict", true) ||
          this.contains(oData.errorMsg, "already has a job", true) ||
          this.contains(oData.errorMsg, "not scheduled to accept jobs", true)
        ) {
          if (!mSilent) {
            // NOTE: the desktop has a 'find a tech' option. Not currently supporting that... may need to in the future. SRR 01/15/2020
            var mChoice = await this.mbox(
              oData.errorMsg,
              this.getLbl("assign anyway"),
              this.getLbl("cancel")
            );
            if (mChoice == 1) {
              // assign anyways
    ...
    Vue.prototype.Sublib.techPassJobTrain = async function(
      mUserId,
      mJobsId,
      mJobschedId,
      mTaskList,
    ...
    Vue.prototype.Sublib.convQt2Job = async function(mQuoteId) {
      ...
      var mChoice = await this.mbox(
        this.getLbl("confirm convert quote"),
        this.getLbl("convert"),
        this.getLbl("cancel")
      );
      if (mChoice == 2) {
    ...
    Vue.prototype.Sublib.convQt2NSI = async function(mQuoteId) {
      ...
      var mChoice = await this.mbox(
        this.getLbl("confirm convert quote nsi"),
        this.getLbl("convert"),
        this.getLbl("cancel")
      );
      if (mChoice == 2) {
      ...
      var oMenu = [
        ...
        {
          desc: this.getLbl("email - link pdf"),
          code: "EmailLinkPDFInv",
          icon: ""
        },
        { isDivider: true },
      ...
      emailExtraText =
        ...
        this.getLbl("inv amt") +
        ": " +
        this.formatCurrency(oData[0].invamt);
      ...
      if (mChoice == "EMAILPDFINV") {
        ...
        oQuickTo = await this.popQuickTo(
          "invoice",
          mBuildersId,
          "",
          mInvoiceId,
        ...
        mGoOn = await this.email(
          oData[0].downloadpath,
          mSubject,
          mBody,
          "",
          oQuickTo,
        ...
        await this.sendCustInvLink(
          mInvoiceId,
          mBuildersId,
          true,
          this.contains(mChoice, "INVFT"),
          emailExtraText,
          this.contains(mChoice, "LINKPDF")
        );
    ...
    Vue.prototype.Sublib.turnZoomOnOff = function(mTurnOnOff) {
      ...
      var mNewContent,
        mMaxScale = "10.0"; // max of 10.0 (between 1.0 and 10.0)

      if (mTurnOnOff == "ON") {
        // make it zoomable
        //<meta name="viewport" content="width=device-width,initial-scale=1.0,shrink-to-fit=no,maximum-scale=1.0, user-scalable=no">
        mNewContent = mOrigContent
          .replace("maximum-scale=1,", "maximum-scale=" + mMaxScale + ",") // may not have the .0, have to include the ',' so it doesn't replace it twice
        ...
        //<meta name="viewport" content="width=device-width,initial-scale=1.0,shrink-to-fit=no,maximum-scale=1.0, user-scalable=no">
        mNewContent = mOrigContent
          .replace("maximum-scale=" + mMaxScale, "maximum-scale=1.0")
    ...
    Vue.prototype.Sublib.showMenu = function(
      MenuOptions,
      mParam1Name,
      mParam1Val,
      mParam2Name,
    ...
    Vue.prototype.Sublib.screenShot = async function(
      hideBottomBar,
      htmlElement
    ) {
      ...
      if (oBottomBar) {
        ...
        await this.sleep(0.1 * 1000); // give it a second to hide
      }
    ...
    (Vue.prototype.Sublib.screenShot_html2canvas = async function(htmlElement) {
      ...
      if (!htmlElement) htmlElement = document.body;
      ...
      //
      // Returns: Base64 String
      (Vue.prototype.Sublib.screenShot_domtoimage = async function(
        htmlElement
      ) {
        // htmlElement = Char. Html Element to take screen shot of. Usually document.body
    ...
    Vue.prototype.Sublib.getVersionType = function() {
      ...
      if (!mMode) {
        ...
        try {
          ...
          if (
            !oMode.datadt ||
            Math.abs(this.daysBetween(new Date(), oMode.datadt)) > 0
          ) {
            // get it once a day
            this.refreshVersionType();
          }
    ...
    Vue.prototype.Sublib.refreshVersionType = async function() {
      ...
      localStorage.setItem(
        "licModules",
        JSON.stringify(this.wsResp2Obj(resp, 2))
      );
      return;
    }; // getModeVersion
    ...
    (Vue.prototype.Sublib.forceCPBooks = function() {
      ...
      (Vue.prototype.Sublib.hasCPAccounting = function(branchesId) {
        ...
        if (branchesId) {
          ...
          let oLic = oMods.find(
            obj => obj.active && obj.module10 && obj.status != "DEMO"
          );
          if (oLic) {
            retval = true;
          } else {
    ...
    Vue.prototype.Sublib.applyPmt = async function(
      mType,
      mPmtDt,
      aInvs,
      mNotes,
      ...
      var oBodyParams = {
        ...
        fttasks:
          oFTTasks && oFTTasks.length > 0 ? JSON.stringify(oFTTasks) : "",
        pmtNotes: mNotes,
        last4: mCCLast4,
        refNo: mRefNo,
    ...
    // Returns: Logical. true if it worked, false if it failed (displays it's own error messages)
    Vue.prototype.Sublib.applyExpense = async function(
      bankGLCode,
      mType,
      mPmtDt,
      aInvs,
    ...
    Vue.prototype.Sublib.signOut = async function(mNoPageChange) {
      ...
      for (var mx = 0; mx < this.IDB.aDBList.length; mx++) {
        for (var my = 0; my < this.IDB.aDBList[mx].aTables.length; my++) {
          await this.IDB.req(
            this.IDB.aDBList[mx].aTables[my],
            "deleteall",
            false,
            false,
            this.IDB.aDBList[mx].db
          );
        } // for (aTables)
      } // for (aDBList)
    ...
    Vue.prototype.Sublib.promptSwitchKeyBoard = async function(mForceShow) {
      ...
      var mShowedPrompt = this.convFromStr(
        localStorage.getItem("inputMask_tryGBoard")
      );
      ...
      var mMsg =
        '<span style="color:red">The keyboard you are using will not work correctly with CenPoint.</span>' +
        "\n" +
        ...
        if (this.usingWebview("android") && android.getSystemKeyBoard) {
          ...
          if (
            (oDevice.manufacturer &&
              oDevice.manufacturer.toLowerCase() == "samsung") ||
            (!oDevice.manufacturer &&
              (this.left(oDevice.product, 2).toUpperCase() == "SM" ||
                this.contains(oDevice.product, "galaxy", true)))
          ) {
            ...
            (oDevice.manufacturer &&
              oDevice.manufacturer.toLowerCase() == "lg") ||
            (!oDevice.manufacturer &&
              this.left(oDevice.product, 3).toUpperCase() == "LM-")
          ) {
            // assume LG keyboard
    ...
    Vue.prototype.Sublib.isKeyboardOkay = function() {
      ...
      var mRetVal;
      if (
        this.contains(mKeyBoard, "samsung", true) || // Samsung
    ...
    Vue.prototype.Sublib.isAlphaNumeric = function(mTestString) {
      ...
      for (var mx = 0; mx < mTestString.length; mx++) {
        ...
        if (
          !this.between(mAsciiVal, 48, 57) && // 0-9
    ...
    Vue.prototype.Sublib.scrollTo = async function(
      mDomID,
      passedOffset,
      container
    ) {
      ...
      try {
        ...
        console.log(
          "Scroll to element: " + mDomID + " failed. Error: " + ignore.message
        );
      }
    }; // scrollTo
    ...
    Vue.prototype.Sublib.calcFeeAmt = function(
      mAmt,
      mFeeType,
      mFeeAmt,
      mFeeType2,
    ...
    Vue.prototype.Sublib.alertSupport = async function(
      mServer,
      mMsg,
      mSwitchServersFirst
    ) {
      ...
      if (oData.errorMsg) {
        this.mbox(
          "Server: " +
            mServer +
            " is experiencing problems and an error occurred alerting CenPoint. Please let CenPoint know!" +
            "\nError: " +
            oData.errorMsg
        );
      }
    ...
    Vue.prototype.Sublib.hasUnsubmittedFTs = async function(mDate) {
      ...
      var resp = await this.RestClient.get(
        mURL,
        mParams,
        "getPrevUnsubmittedFTs~dt=" + mParams.dt
      );
      ...
      if (oData.errorMsg) {
        ...
        oData.info &&
        this.contains(oData.info, "All FTs submitted", true)
      ) {
        ...
        if (mChoice == 1) {
          ...
          this.router.push({
            path: "ftick",
            query: {
              jobschedid: oData[0].ftickid,
              branchesid: oData[0].branchesid
            }
          });
        } else {
          // nothing to do.
    ...
    Vue.prototype.Sublib.calcFTTimes = function(
      mStartedTime,
      mStartedDate,
      mArrivedTime,
      mArrivedDate,
      ...
      mDepartedFull = this.newDate(
        this.DTOC(mDepartedDate) + " " + mDepartedTime
      );
      mCompletedFull = this.newDate(
        this.DTOC(mCompletedDate) + " " + mCompletedTime
      );
      ...
      mTravel = this.math.round(
        (mArrivedFull - mStartedFull + (mCompletedFull - mDepartedFull)) /
          1000 /
          60,
        0
      );
    ...
    Vue.prototype.Sublib.getBranchInfo = async function(mBranchesId, mWhat) {
      ...
      var resp = await this.RestClient.get(
        mURL,
        oParams,
        "getBranchInfo~branchesId=" + mBranchesId + "~what=" + mWhat
      );
    ...
    // *********************************************************************************
    // This is basically a wrapper method to call the same method on the web service
    Vue.prototype.Sublib.popQuickTo = async function(
      mSource,
      mBuildersId,
      mJobsId,
      mInvList,
    ...
    Vue.prototype.Sublib.sendCustInvLink = async function(
      mInvoiceId2Send,
      mBuildersId,
      mEmailMode,
      mIncludeFT,
      ...
      // First, figure out what number to send it to
      var oQuickTo = await this.popQuickTo(
        "invoice",
        mBuildersId,
        "",
        mInvoiceId2Send,
      ...
      if (!oQuickTo || !oQuickTo.length) {
        ...
        if (oQuickTo[0].bldrnolinks) {
          mChoice = await this.mbox(
            this.getLbl("cust not flagged for links send pdf"),
            this.getLbl("send link anyway"),
            this.getLbl("send pdf"),
            this.getLbl("cancel")
          );
          if (mChoice == 1) {
      ...
      if (mEmailMode) {
        // email it out
        var mSubject =
          this.getLbl("invoice") + " " + this.trimZeros(mInvoiceId2Send, 5);
        ...
        var mSigLink = mBody
          .substring(this.getIndex(mBody, oData[0].url))
          .trim(); // bit.cenpoint.com/j5l6 or 'lnk.cenpoint.com/l?abcd (switched ot our own links. SRR 06/03/2023)
        ...
        mBody = this.strtran(
          mBody,
          this.strtran(mSigLinkOrig, "\\?", "\\?"),
          '<a href="' + mSigLink + '">' + "View Invoice" + "</a>"
        ); // strtran doesn't work right with ? in it. SRR 06/03/2023
        ...
        var mGoOn = await this.sendLink2Cust(
          oData[0].msg,
          "",
          "",
          oQuickTo,
      ...
      if (oData.errorMsg) {
        this.mbox(
          "Error Updating Invoice Flags (but invoice was sent): " +
            oData.errorMsg
        );
        //return;
      }
    ...
    // Typically this is done by the sales rep in the field but this is just another option for the office to try to take care of it.
    // Returns: Logical. .T. if it worked, otherwise .F.
    Vue.prototype.Sublib.sendCustQTLink = async function(
      mQuoteId2Send,
      mBuildersId,
      mEmailMode,
      mEmailExtraText,
      ...
      if (mEmailMode) {
        // email it out
        var mSubject =
          this.getLbl("quote") + " " + this.trimZeros(mQuoteId2Send, 5);
        var mBody = oData[0].msg;
      ...
      if (oData.errorMsg) {
        this.mbox(
          "Error Updating Quote Flag (but quote was sent): " + oData.errorMsg
        );
        //return;
      }
    ...
    Vue.prototype.Sublib.justFName = function(mString) {
      ...
      return mString.substr(
        this.getIndex(mString, mSlashChar, this.occurs(mString, mSlashChar)) + 1
      );
    }; // justFNmae

    // *********************************************************************************
    // This is basically a wrapper around putUDS on the webservice
    Vue.prototype.Sublib.putUDS = async function(
      mID_,
      mUserID_,
      mValue_,
      maddrecord,
    ...
    Vue.prototype.Sublib.areEqualObjs = function(obj1, obj2) {
      ...
      for (const key of keys1) {
        ...
        if (
          (areObjects && !this.areEqualObjs(val1, val2)) ||
    ...
    Vue.prototype.Sublib.getEmailSig = async function(mUserId) {
      ...
      if (!mUserId) mUserId = localStorage.getItem("userId");
      ...
      if (!oEmail[0].emaillogobase64) {
        ...
        if (
          !this.contains(mEmailMsg, "<LOGO>") &&
          !this.contains(mEmailMsg, "<img")
        ) {
          // Add in my plcaceholder (otherwise the image won't be used)
          if (this.right(mEmailMsg, 10) == "<br /></p>") {
            mEmailMsg = this.strtran(
              mEmailMsg,
              "<br /></p>",
              "<br /><LOGO></p>",
              this.occurs(mEmailMsg, "<br /></p>")
            );
      ...
      if (this.contains(mEmailMsg, "<LOGO>")) {
        ...
        mStr2Replace = mStr2Replace.substring(
          0,
          mStr2Replace.indexOf("/>") + 1
        );
      } else {
        mStr2Replace = "";
      }
      ...
      if (!oEmail[0].emaillogobase64) {
        ...
        mReplacement =
          ...
          oEmail[0].emaillogobase64 +
          '" width="' +
          mWidth +
          '" />';
        if (oEmail[0].emaillogol) {
          mReplacement =
            '<a href="' + oEmail[0].emaillogol + '">' + mReplacement + "</a>";
        }
      }
    ...
    Vue.prototype.Sublib.getBranchID = async function(
      mCboBranchValue,
      mUseUserDflt
    ) {
      if (this.isNumeric(mCboBranchValue)) return mCboBranchValue;
    ...
    Vue.prototype.Sublib.parseName = function(mFullname, mFLM, retObj) {
      ...
      if (mWordCount == 4) {
        if (mFullname.indexOf(",") == -1) mWarning = true;
      }
    ...
    Vue.prototype.Sublib.checkSignIn = async function(mForceSignIn, token) {
      ...
      if (!mForceSignIn && this.getConnectInfo("token")) {
        ...
        var mGoon = await this.showSimplePopUp(this.Vue.extend(SIGNINPOPUP), {
          token: token
        });
    ...
    Vue.prototype.Sublib.confirmPwd = async function(mReqSALogin) {
      ...
      var oParams = {
        ...
        formCaption: mReqSALogin
          ? this.getLbl("must enter admin cred to proceed")
          : this.getLbl("confirm pwd to proceed"),
        verifyOnly: true
      };
      var mGoon = await this.showSimplePopUp(
        this.Vue.extend(SIGNINPOPUP),
        oParams
      );
    ...
    Vue.prototype.Sublib.roundTime = function(mTm, mRoundUpAt, mRoundInterval) {
      ...
      if (typeof mTm == "number") {
        ...
        if (this.occurs(":", mTm) > 0) {
          ...
          mMin = Math.floor(
            Number(mTm.substring(mTm, this.getIndex(mTm, ":")))
          );
        } else {
      ...
      if (typeof mTm == "number") {
        ...
        mRetVal =
          this.padL(String(mHrs), mHrLen, "0") +
          ":" +
          this.padL(String(mMin), 2, "0");
        if (this.occurs(":", mTm) == 0) {
    ...
    Vue.prototype.Sublib.getCustomerAgingLink = async function(
      mBuildersId,
      mForceSend = false,
      mIncludeDftStmt = false
    ) {
      //get the aging link
      ...
      if (oData.errorMsg) {
        if (
          this.contains(oData.errorMsg, "not accept links") ||
          oData.errorCode == -953
        ) {
    ...
    Vue.prototype.Sublib.translate = async function(
      mText2Translate,
      mNewLang,
      mOrigLang
    ) {
    ...
    Vue.prototype.Sublib.showTranslateMenu = async function(
      mText2Translate,
      copy2ClipboardOpt,
      onlyReturnCode
    ) {
    ...
    Vue.prototype.Sublib.getUsersBGImg = async function(mForceNew) {
      ...
      if (
        localStorage.getItem("userType") != "FULL" ||
        !this.getConnectInfo("token")
      ) {
    ...
    Vue.prototype.Sublib.getCustLogo = async function() {
      ...
      if (oData[0].website) {
        ...
        // }
        if (
          !this.contains(mWebSite, "http://") &&
          !this.contains(mWebSite, "https://")
        ) {
    ...
    Vue.prototype.Sublib.getBannerMsg = async function() {
      if (this.offline()) {
        ...
        if (mHold) {
          ...
          if (
            !oHold.errorMsg &&
            oHold[0] &&
            mNow < this.newDate(oHold[0].enddt)
          ) {
      ...
      var mType =
        localStorage.getItem("userType") == "FULL" ? "OFFICE" : "TECH";
    ...
    Vue.prototype.Sublib.initPushNotif = async function() {
      ...
      if (
        pushEnabled == "false" ||
        (typeof this.convFromStr(pushEnabled) == "boolean" &&
          !this.convFromStr(pushEnabled))
      ) {
    ...
    Vue.prototype.Sublib.initFireBase = async function(forceUpdt) {
      ...
      if (this.usingWebview()) {
        ...
        if (pushToken) {
          ...
          if (this.isTestingIP()) {
            await this.mbox(
              "Push Notifications NOT Enabled! Push Token = " + pushToken
            );
          }
        }
        ...
        if (!("Notification" in window) && !this.isIOS()) {
          ...
          this.showMsg(
            this.getLbl("browser does not support push notification"),
            3
          );
        ...
        if (Notification.permission === "default") {
          //|| Notification.permission === "denied") { Browser won't prompt again, just don't do anything
    ...
    Vue.prototype.Sublib.initFireBaseMessaging = async function(mClientId) {
      ...
      try {
        var currentToken = await fb_getToken(mFBMessaging, {
          vapidKey: mClientId
        });
        ...
        if (error.message.toLowerCase().indexOf("secure origin") > -1) {
          ...
          this.showMsg(
            this.getLbl("failed to initialize push notif") +
              "\n\n" +
              error.message,
            3
          );
    ...
    Vue.prototype.Sublib.updateFBMToken = async function(
      fbm_token,
      updateRec,
      fbm_token_old,
      activate,
      ...
      var resp = await _this.RestClient.post(
        mURL,
        oParams,
        mBodyParams,
        "updatePushToken"
      ...
      if (oData.errorMsg) {
        _this.mbox(
          _this.getLbl("failed to save notif token") +
            "\n\n Error Message: " +
            oData.errorMsg
        );
        return false;
    ...
    Vue.prototype.Sublib.deleteFBMToken = async function(fbm_token) {
      ...
      if (oData.errorMsg) {
        if (this.contains(oData.errorMsg, "no fbm token to delete", true)) {
          ...
          this.mbox(
            this.getLbl("failed to delete notif token") +
              "\n\n Error Message: " +
              oData.errorMsg
          );
          return false;
    ...
    Vue.prototype.Sublib.initTextNotifications = async function(verifyInfo) {
      ...
      if (
        ((!Sublib.emptyNull(localStorage.getItem("fbm_token")) &&
          !Sublib.emptyNull(localStorage.getItem("cellCoid"))) ||
      ...
      if (
        Sublib.emptyNull(server) ||
        Sublib.emptyNull(custcode) ||
        Sublib.emptyNull(token)
      ) {
      ...
      Restangular.all("getPhoneCarriers")
        .customGET("", mParams)
        .then(function(response) {
          ...
          if (mStart != -1 && mEnd != -1) {
            // actual data returned
            var mUsableData = response.substr(
              mStart + 1,
              mEnd + 2 - (mStart + 1)
            );
            try {
              ...
              $rootScope.regNumForm.closePromise.then(function(data) {
                ...
                if (data.value == true) {
                  localStorage.setItem(
                    "fbm_on",
                    $rootScope.textPushOn ? "true" : "false"
                  );
                  ...
                  if (
                    !Sublib.emptyNull($rootScope.phoneNum) &&
                    !Sublib.emptyNull($rootScope.carrier)
                  ) {
                    // make rest call to save number
                    Sublib.updateFBMToken(
                      cleanNumber($rootScope.phoneNum),
                      true,
                      mOldToken,
                      true,
                      "",
                  ...
                  if ($rootScope.recEmail) {
                    ...
                    Sublib.updateFBMToken(
                      ...
                      $rootScope.recEmail,
                      !$rootScope.recEmail
                    ); // web service is looking for 'email'
                  }
              ...
              ngDialog.openConfirm({
                data: {
                  message: "Error retreiving phone carriers: " + response
                }
              });
            }
          } else {
            ngDialog.openConfirm({
              data: { message: "Error retreiving phone carriers: " + response }
            });
          }
        })
    ...
    //**************************************************************************************************************
    // Geo code builders
    Vue.prototype.Sublib.geoBldr = async function(
      blockCnt,
      throttle,
      silentMode
    ) {
    ...
    //**************************************************************************************************************
    // geo code jobs
    Vue.prototype.Sublib.geoJob = async function(
      blockCnt,
      throttle,
      silentMode
    ) {
    ...
    Vue.prototype.Sublib.setFocus = async function(
      elementId,
      ctrlAIt,
      lessSleep
    ) {
      ...
      if (typeof elementId == "string") {
        ...
        typeof elementId == "object" &&
        elementId.tagName &&
        elementId.tagName == "INPUT"
      ) {
    ...
    Vue.prototype.Sublib.getBranches = async function(
      mIncludaAllOpts,
      mForceBranchesList,
      mForcedListOnly
    ) {
    ...
    Vue.prototype.Sublib.invalidExt = function(mFileType, mSilentMode) {
      ...
      var invalidFileType = this.inList(mFileType, [
        "EXE",
        "MSI",
        "DMG",
        "BAT",
    ...
    Vue.prototype.Sublib.checkEFTPmts = async function(silentMode) {
      ...
      if (!silentMode) {
        ...
        msg = msg.replace(
          "<TOT>",
          String(oData[0].cleared + oData[0].failed + oData[0].nochange)
        );
    ...
    Vue.prototype.Sublib.formatGL = function(oGL) {
      ...
      let retval =
        (oGL.glcode && !oGL.glhideno ? oGL.glcode + " - " : "") +
        (oGL.gldescript ? oGL.gldescript : oGL.descript);
      return retval;
    }; // getAddId
    ...
    Vue.prototype.Sublib.calcTableMaxHeight = function(htmlId, tableTopSet) {
      ...
      while (!oContainer) {
        ...
        if (this.contains(oHold.classList.value, "v-dialog", true)) {
          ...
          break;
        } else if (oHold.id && oHold.id == "router-view") {
          // id=="app"
      ...
      let contentAboveTable = Math.abs(
        (tableTopSet ? 0 : oContainer.getBoundingClientRect().top) - tableTop
      );
      let contentBelowTable = Math.abs(
        oContainer.getBoundingClientRect().bottom -
          oTable.getBoundingClientRect().bottom
      );
      ...
      if (true || !dialog) {
        ...
        if (fixedElements) {
          for (var mx = 0; mx < fixedElements.length; mx++) {
            if (
              fixedElements[mx].getBoundingClientRect().top <= tableTop ||
              this.contains(
                fixedElements[mx].classList.value,
                "v-navigation-drawer",
                true
              )
            ) {
            ...
            contentBelowTable += fixedElements[mx].getBoundingClientRect()
              .height;
          }
        }
      } // !dialog
    ...
    Vue.prototype.Sublib.viewJournalRefType = async function(
      oJournal,
      forceJournalView
    ) {
      ...
      if (
        forceJournalView ||
        oJournal.refidtype == "JRN" ||
        this.left(oJournal.refid, 3) == "IMP" ||
        this.refidtype == "STB"
      ) {
        //this.btnOptionsClicked(oJournal, 'VIEW');
        let journalId = oJournal.journalid;
        if (this.contains(journalId, "_")) journalId = this.left(journalId, 10); // something like '0000359492_9' See journalRef for when it adds this on
        ...
        // show surplus refund
        retval = await this.showSimplePopUp(this.Vue.extend(SURPLUS), {
          refundId: oJournal.refid,
          buildersId: oJournal.whonameid,
          dfltBranchesId: oJournal.branchesid
        });
      } else if (oJournal.refidtype == "VI_") {
        // vendor invoice

        retval = await this.showSimplePopUp(this.Vue.extend(FINDVENDINVPOPUP), {
          vendorInvId: oJournal.refid,
          vendorId: oJournal.whonameid,
          dfltBranchesId: oJournal.branchesid
        });
      } else if (oJournal.refidtype == "EXP") {
        // expense
        ...
        retval = await this.showSimplePopUp(
          this.Vue.extend(FINDEXPENSE),
          "oDfltFilters",
          oFilters
        );
      } else {
    ...
    Vue.prototype.Sublib.startChkActivityTimer = async function(
      forceGetSetting
    ) {
      ...
      if (this.tmrNoActivity || this.isAndroid() || this.isIOS()) return; // already running or on a phone. I'm out

      let noActivityDur = localStorage.getItem("signOutNoA");
      let lastCheck = localStorage.getItem("signOutNoALastGet");
      if (
        !lastCheck ||
        this.daysBetween(this.convFromStr(lastCheck), this.newDate()) != 0
      ) {
      ...
      if (!noActivityDur) return; // 0 minutes, basically it's turned off
        ...
        if (minSinceMbox >= maxTimeToReply) {
          ...
          if (!mboxShowing) {
            ...
            _this
              .mbox(
                _this
                  .getLbl("are you still there")
                  .replace("<TIME>", _this.AmPm(mNow.addMin(maxTimeToReply))),
                _this.getLbl("im still here")
              )
              .then(function() {
                mboxShowDtTm = null;
                mboxShowing = false;
    ...
    Vue.prototype.Sublib.numToWord = function(number) {
      ...
      var SCALES = ["thousand", "million", "billion", "trillion"].map(str => {
        return str.toProperCase();
      });
      ...
      let retval = chunk(oNumParts.numB4Dec)
        .map(inEnglish)
        .map(appendScale)
        .reverse()
        .join(" ");
      retval +=
        (retval ? "" : "Zero") +
        " and " +
        (oNumParts.decNumStr ? oNumParts.decNumStr : "00") +
        "/100";
    ...
    Vue.prototype.Sublib.flagInvSent = async function(
      mAlreadyPrompted,
      invoiceIdList
    ) {
      ...
      if (oData.errorMsg) {
        if (
          this.contains(oData.errorMsg, "need to prompt", true) &&
          oData.errorCode == -12
        ) {
          //need to prompt them
          return 0;
    ...
    Vue.prototype.Sublib.getResultsNextPage = async function(
      resultSet,
      nextRec,
      maxRecCnt
    ) {
    ...
    Vue.prototype.Sublib.verifySQLDict = async function() {
      ...
      this.showMsg(
        this.getLbl("talking to the server please wait"),
        false,
        true
      );
    ...
    Vue.prototype.Sublib.getSelfPic = async function(
      userId,
      forceGet,
      returnVal
    ) {
      ...
      if (cachedBase64 && !forceGet) {
        ...
        selfPic =
          "data:" +
          this.getMimeType(
            oData[0].selfpicdesc ? this.justExt(oData[0].selfpicdesc) : "PNG"
          ) +
          ";base64," +
          oData[0].thmbase64;
    ...
    Vue.prototype.Sublib.getPublicIP = async function() {
      let resp = await this.RestClient.getNoCache(
    ...
    Vue.prototype.Sublib.setAppZoom = function(zoomLevel) {
      ...
      try {
        if ((zoomLevel == 100) & !document.body.style.zoom) return; // default in the browser, just leave it. SRR 12/15/2023
